...
#include "stanExports_leecarterfinal.h"

RCPP_MODULE(stan_fit4leecarterfinal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_leecarterfinal")
