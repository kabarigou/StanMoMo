...
#include "stanExports_APCmodelfinalnb.h"

RCPP_MODULE(stan_fit4APCmodelfinalnb_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_APCmodelfinalnb")
