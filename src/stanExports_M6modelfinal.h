...
namespace model_M6modelfinal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_M6modelfinal");
    reader.add_event(86, 84, "end", "model_M6modelfinal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_M6modelfinal : public prob_grad {
private:
        int J;
        int T;
        std::vector<int> d;
        ...
        int L;
public:
    model_M6modelfinal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_M6modelfinal_namespace::model_M6modelfinal";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_M6modelfinal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_M6modelfinal_namespace::model_M6modelfinal stan_model;
#endif
