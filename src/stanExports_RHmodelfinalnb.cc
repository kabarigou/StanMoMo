...
#include "stanExports_RHmodelfinalnb.h"

RCPP_MODULE(stan_fit4RHmodelfinalnb_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_RHmodelfinalnb")
