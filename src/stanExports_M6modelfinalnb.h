...
namespace model_M6modelfinalnb_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_M6modelfinalnb");
    reader.add_event(87, 85, "end", "model_M6modelfinalnb");
    return reader;
}
#include <stan_meta_header.hpp>
class model_M6modelfinalnb : public prob_grad {
private:
        int J;
        int T;
        std::vector<int> d;
        ...
        int L;
public:
    model_M6modelfinalnb(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_M6modelfinalnb_namespace::model_M6modelfinalnb";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(get_base1(gs, 2, "gs", 1), ((psi + psi2) * get_base1(gs, 1, "gs", 1)), get_base1(sigma, 3, "sigma", 1)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_M6modelfinalnb_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_M6modelfinalnb_namespace::model_M6modelfinalnb stan_model;
#endif
