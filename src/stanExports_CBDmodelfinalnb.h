...
namespace model_CBDmodelfinalnb_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_CBDmodelfinalnb");
    reader.add_event(63, 61, "end", "model_CBDmodelfinalnb");
    return reader;
}
#include <stan_meta_header.hpp>
class model_CBDmodelfinalnb : public prob_grad {
private:
        int J;
        int T;
        std::vector<int> d;
        ...
        int L;
public:
    model_CBDmodelfinalnb(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_CBDmodelfinalnb_namespace::model_CBDmodelfinalnb";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_CBDmodelfinalnb_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_CBDmodelfinalnb_namespace::model_CBDmodelfinalnb stan_model;
#endif
