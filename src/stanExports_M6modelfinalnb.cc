...
#include "stanExports_M6modelfinalnb.h"

RCPP_MODULE(stan_fit4M6modelfinalnb_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_M6modelfinalnb")
