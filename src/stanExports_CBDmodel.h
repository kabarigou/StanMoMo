...
#include <stan/model/model_header.hpp>
<<<<<<< HEAD:src-x64/stanExports_M6model.h
namespace model_M6model_namespace {
=======
namespace model_CBDmodel_namespace {
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1:src/stanExports_CBDmodel.h
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
using std::istream;
using std::string;
...
<<<<<<< HEAD
    reader.add_event(0, 0, "start", "model_CBDmodel");
    reader.add_event(121, 119, "end", "model_CBDmodel");
    return reader;
}
#include <stan_meta_header.hpp>
class model_CBDmodel : public prob_grad {
=======
<<<<<<< HEAD:src-x64/stanExports_M6model.h
...
=======
    reader.add_event(0, 0, "start", "model_CBDmodel");
    reader.add_event(106, 104, "end", "model_CBDmodel");
    return reader;
}
#include <stan_meta_header.hpp>
class model_CBDmodel
  : public stan::model::model_base_crtp<model_CBDmodel> {
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1:src/stanExports_CBDmodel.h
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
private:
        int J;
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                    stan::model::assign(mu, 
                                ...
                                ((get_base1(offset, pos, "offset", 1) + get_base1(k, t, "k", 1)) + ((get_base1(age, x, "age", 1) - mean(age)) * get_base1(k2, t, "k2", 1))), 
...
=======
            ...
            current_statement_begin__ = 53;
            lp_accum__.add(exponential_log(get_base1(sigma, 2, "sigma", 1), 1));
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1:src/stanExports_CBDmodel.h
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
            }
        } catch (const std::exception& e) {
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                        stan::model::assign(mufor, 
                                    stan::model::cons_list(stan::model::index_uni(pos), stan::model::nil_index_list()), 
                                    (get_base1(k_p, t, "k_p", 1) + ((get_base1(age, x, "age", 1) - mean(age)) * get_base1(k2_p, t, "k2_p", 1))), 
                                    "assigning variable mufor");
<<<<<<< HEAD
                        current_statement_begin__ = 86;
                        stan::math::assign(pos, (pos + 1));
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                        stan::model::assign(log_lik, 
                                    stan::model::cons_list(stan::model::index_uni(pos2), stan::model::nil_index_list()), 
                                    poisson_log_log(get_base1(d, pos2, "d", 1), ((get_base1(offset, pos2, "offset", 1) + get_base1(k, t, "k", 1)) + ((get_base1(age, x, "age", 1) - mean(age)) * get_base1(k2, t, "k2", 1)))), 
                                    "assigning variable log_lik");
<<<<<<< HEAD
                        current_statement_begin__ = 91;
                        stan::math::assign(pos2, (pos2 + 1));
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                        stan::model::assign(log_lik2, 
                                    stan::model::cons_list(stan::model::index_uni(pos3), stan::model::nil_index_list()), 
                                    poisson_log_log(get_base1(dval, pos3, "dval", 1), ((get_base1(offset2, pos3, "offset2", 1) + get_base1(k_p, t, "k_p", 1)) + ((get_base1(age, x, "age", 1) - mean(age)) * get_base1(k2_p, t, "k2_p", 1)))), 
                                    "assigning variable log_lik2");
<<<<<<< HEAD
...
<<<<<<< HEAD
                ...
                for (int t = 1; t <= Tfor; ++t) {
                    ...
                    for (int x = 1; x <= J; ++x) {
                        current_statement_begin__ = 101;
                        if (as_bool(logical_gt(stan::math::fabs((get_base1(k_p, t, "k_p", 1) + ((get_base1(age, x, "age", 1) - mean(age)) * get_base1(k2_p, t, "k2_p", 1)))), 15))) {
                            current_statement_begin__ = 102;
=======
<<<<<<< HEAD:src-x64/stanExports_M6model.h
...
<<<<<<< HEAD
                            ...
                            stan::model::assign(mufor, 
                                        stan::model::cons_list(stan::model::index_uni(pos), stan::model::nil_index_list()), 
                                        gamma_rng(phi, (phi / stan::math::exp((get_base1(k_p, t, "k_p", 1) + ((get_base1(age, x, "age", 1) - mean(age)) * get_base1(k2_p, t, "k2_p", 1))))), base_rng__), 
                                        "assigning variable mufor");
                            current_statement_begin__ = 106;
=======
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                        stan::model::assign(log_lik, 
                                    stan::model::cons_list(stan::model::index_uni(pos2), stan::model::nil_index_list()), 
                                    neg_binomial_2_log_log(get_base1(d, pos2, "d", 1), ((get_base1(offset, pos2, "offset", 1) + get_base1(k, t, "k", 1)) + ((get_base1(age, x, "age", 1) - mean(age)) * get_base1(k2, t, "k2", 1))), phi), 
                                    "assigning variable log_lik");
<<<<<<< HEAD
                        current_statement_begin__ = 111;
                        stan::math::assign(pos2, (pos2 + 1));
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                        stan::model::assign(log_lik2, 
                                    stan::model::cons_list(stan::model::index_uni(pos3), stan::model::nil_index_list()), 
                                    neg_binomial_2_log_log(get_base1(dval, pos3, "dval", 1), ((get_base1(offset2, pos3, "offset2", 1) + get_base1(k_p, t, "k_p", 1)) + ((get_base1(age, x, "age", 1) - mean(age)) * get_base1(k2_p, t, "k2_p", 1))), phi), 
                                    "assigning variable log_lik2");
<<<<<<< HEAD
                        current_statement_begin__ = 116;
=======
...
<<<<<<< HEAD
typedef model_CBDmodel_namespace::model_CBDmodel stan_model;
=======
<<<<<<< HEAD:src-x64/stanExports_M6model.h
