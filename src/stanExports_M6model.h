...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.scalar_unconstrain(alpha2);
        } catch (const std::exception& e) {
        ...
        psi = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(-(1), 1, psi);
        } catch (const std::exception& e) {
        ...
        psi2 = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(-(1), 1, psi2);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                alpha2 = in__.scalar_constrain(lp__);
            else
            ...
            if (jacobian__)
                psi = in__.scalar_lub_constrain(-(1), 1, lp__);
            else
            ...
            if (jacobian__)
                psi2 = in__.scalar_lub_constrain(-(1), 1, lp__);
            else
    ...
    void write_array(RNG& base_rng__,
        ...
        double psi = in__.scalar_lub_constrain(-(1), 1);
        vars__.push_back(psi);
        double psi2 = in__.scalar_lub_constrain(-(1), 1);
        ...
        try {
            ...
            stan::model::assign(k_p, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                        ((get_base1(k, T, "k", 1) + alpha) + (get_base1(sigma, 1, "sigma", 1) * normal_rng(0, 1, base_rng__))), 
            ...
            for (int t = 2; t <= Tfor; ++t) {
                ...
                stan::model::assign(k_p, 
                            ...
                            ((get_base1(k_p, (t - 1), "k_p", 1) + alpha) + (get_base1(sigma, 1, "sigma", 1) * normal_rng(0, 1, base_rng__))), 
                            "assigning variable k_p");
            }
            current_statement_begin__ = 82;
            stan::model::assign(k2_p, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                        ((get_base1(k2, T, "k2", 1) + alpha2) + (get_base1(sigma, 2, "sigma", 1) * normal_rng(0, 1, base_rng__))), 
            ...
            for (int t = 2; t <= Tfor; ++t) {
                ...
                stan::model::assign(k2_p, 
                            stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                            ((get_base1(k2_p, (t - 1), "k2_p", 1) + alpha2) + (get_base1(sigma, 2, "sigma", 1) * normal_rng(0, 1, base_rng__))), 
                            "assigning variable k2_p");
            }
