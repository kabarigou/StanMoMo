...
namespace model_RHmodelfinalnb_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_RHmodelfinalnb");
    reader.add_event(87, 85, "end", "model_RHmodelfinalnb");
    return reader;
}
#include <stan_meta_header.hpp>
class model_RHmodelfinalnb : public prob_grad {
private:
        int J;
        int T;
        std::vector<int> d;
        ...
        int L;
public:
    model_RHmodelfinalnb(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_RHmodelfinalnb_namespace::model_RHmodelfinalnb";
        ...
        try {
            ...
            validate_non_negative_index("gs", "(C - 1)", (C - 1));
            num_params_r__ += (C - 1);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        validate_non_negative_index("gs", "(C - 1)", (C - 1));
        context__.validate_dims("parameter initialization", "gs", "vector_d", context__.to_vec((C - 1)));
        Eigen::Matrix<double, Eigen::Dynamic, 1> gs((C - 1));
        size_t gs_j_1_max__ = (C - 1);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                gs = in__.vector_constrain((C - 1), lp__);
            else
                gs = in__.vector_constrain((C - 1));
            current_statement_begin__ = 30;
            ...
            stan::model::assign(g, 
                        stan::model::cons_list(stan::model::index_min_max(2, C), stan::model::nil_index_list()), 
                        gs, 
                        "assigning variable g");
            ...
            lp_accum__.add(normal_log<propto__>(stan::model::rvalue(gs, stan::model::cons_list(stan::model::index_min_max(3, (C - 1)), stan::model::nil_index_list()), "gs"), add(multiply(psi, stan::model::rvalue(gs, stan::model::cons_list(stan::model::index_min_max(2, (C - 2)), stan::model::nil_index_list()), "gs")), multiply(psi2, stan::model::rvalue(gs, stan::model::cons_list(stan::model::index_min_max(1, (C - 3)), stan::model::nil_index_list()), "gs"))), get_base1(sigma, 2, "sigma", 1)));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_RHmodelfinalnb_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> gs = in__.vector_constrain((C - 1));
        size_t gs_j_1_max__ = (C - 1);
        for (size_t j_1__ = 0; j_1__ < gs_j_1_max__; ++j_1__) {
...
typedef model_RHmodelfinalnb_namespace::model_RHmodelfinalnb stan_model;
#endif
