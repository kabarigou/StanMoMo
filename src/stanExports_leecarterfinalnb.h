...
namespace model_leecarterfinalnb_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_leecarterfinalnb");
    reader.add_event(66, 64, "end", "model_leecarterfinalnb");
    return reader;
}
#include <stan_meta_header.hpp>
class model_leecarterfinalnb : public prob_grad {
private:
        int J;
        int T;
        std::vector<int> d;
        ...
        int L;
public:
    model_leecarterfinalnb(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_leecarterfinalnb_namespace::model_leecarterfinalnb";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_leecarterfinalnb_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_leecarterfinalnb_namespace::model_leecarterfinalnb stan_model;
#endif
