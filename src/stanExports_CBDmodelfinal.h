...
namespace model_CBDmodelfinal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_CBDmodelfinal");
    reader.add_event(62, 60, "end", "model_CBDmodelfinal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_CBDmodelfinal : public prob_grad {
private:
        int J;
        int T;
        std::vector<int> d;
        ...
        int L;
public:
    model_CBDmodelfinal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_CBDmodelfinal_namespace::model_CBDmodelfinal";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_CBDmodelfinal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_CBDmodelfinal_namespace::model_CBDmodelfinal stan_model;
#endif
