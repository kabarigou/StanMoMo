...
#include "stanExports_leecarterfinalnb.h"

RCPP_MODULE(stan_fit4leecarterfinalnb_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_leecarterfinalnb")
