...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_RHmodel");
<<<<<<< HEAD
=======
<<<<<<< HEAD:src-x64/stanExports_RHmodel.h
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
    reader.add_event(137, 135, "end", "model_RHmodel");
    return reader;
}
#include <stan_meta_header.hpp>
class model_RHmodel : public prob_grad {
<<<<<<< HEAD
=======
=======
    reader.add_event(125, 123, "end", "model_RHmodel");
    return reader;
}
#include <stan_meta_header.hpp>
class model_RHmodel
  : public stan::model::model_base_crtp<model_RHmodel> {
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1:src/stanExports_RHmodel.h
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
private:
        int J;
        int T;
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
            ...
            validate_non_negative_index("index", "(T - 2)", (T - 2));
            context__.validate_dims("data initialization", "index", "vector_d", context__.to_vec((T - 2)));
            index = Eigen::Matrix<double, Eigen::Dynamic, 1>((T - 2));
            vals_r__ = context__.vals_r("index");
            pos__ = 0;
            size_t index_j_1_max__ = (T - 2);
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                    stan::model::assign(mu, 
                                ...
                                (((get_base1(offset, pos, "offset", 1) + get_base1(a, x, "a", 1)) + (get_base1(b, x, "b", 1) * get_base1(k, t, "k", 1))) + get_base1(g, ((t - x) + J), "g", 1)), 
...
<<<<<<< HEAD:src-x64/stanExports_RHmodel.h
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
            lp_accum__.add(normal_log(get_base1(ks, 1, "ks", 1), (get_base1(alpha, 1, "alpha", 1) + (2 * get_base1(alpha, 2, "alpha", 1))), get_base1(sigma, 1, "sigma", 1)));
            current_statement_begin__ = 58;
            lp_accum__.add(normal_log(stan::model::rvalue(ks, stan::model::cons_list(stan::model::index_min_max(2, (T - 1)), stan::model::nil_index_list()), "ks"), add(add(get_base1(alpha, 1, "alpha", 1), multiply(get_base1(alpha, 2, "alpha", 1), index)), multiply(get_base1(alpha, 3, "alpha", 1), stan::model::rvalue(ks, stan::model::cons_list(stan::model::index_min_max(1, (T - 2)), stan::model::nil_index_list()), "ks"))), get_base1(sigma, 1, "sigma", 1)));
...
=======
=======
            lp_accum__.add(normal_log<propto__>(get_base1(ks, 1, "ks", 1), alpha, get_base1(sigma, 1, "sigma", 1)));
            current_statement_begin__ = 58;
            lp_accum__.add(normal_log<propto__>(stan::model::rvalue(ks, stan::model::cons_list(stan::model::index_min_max(2, (T - 1)), stan::model::nil_index_list()), "ks"), add(alpha, stan::model::rvalue(ks, stan::model::cons_list(stan::model::index_min_max(1, (T - 2)), stan::model::nil_index_list()), "ks")), get_base1(sigma, 1, "sigma", 1)));
            current_statement_begin__ = 59;
            lp_accum__.add(normal_log<propto__>(get_base1(gs, 1, "gs", 1), 0, get_base1(sigma, 2, "sigma", 1)));
            current_statement_begin__ = 60;
            lp_accum__.add(normal_log<propto__>(get_base1(gs, 2, "gs", 1), (psi * get_base1(gs, 1, "gs", 1)), get_base1(sigma, 2, "sigma", 1)));
            current_statement_begin__ = 61;
            ...
            lp_accum__.add(normal_log(a, -(3), 2));
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                        stan::model::assign(mufor, 
                                    stan::model::cons_list(stan::model::index_uni(pos), stan::model::nil_index_list()), 
                                    ((get_base1(a, x, "a", 1) + (get_base1(b, x, "b", 1) * get_base1(k_p, t, "k_p", 1))) + get_base1(gf, (((T + t) - x) + J), "gf", 1)), 
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                        stan::model::assign(log_lik, 
                                    ...
                                    poisson_log_log(get_base1(d, pos2, "d", 1), (((get_base1(offset, pos2, "offset", 1) + get_base1(a, x, "a", 1)) + (get_base1(b, x, "b", 1) * get_base1(k, t, "k", 1))) + get_base1(g, ((t - x) + J), "g", 1))), 
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                        stan::model::assign(log_lik2, 
                                    ...
                                    poisson_log_log(get_base1(dval, pos3, "dval", 1), (((get_base1(offset2, pos3, "offset2", 1) + get_base1(a, x, "a", 1)) + (get_base1(b, x, "b", 1) * get_base1(k_p, t, "k_p", 1))) + get_base1(gf, (((T + t) - x) + J), "gf", 1))), 
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                ...
                for (int t = 1; t <= Tfor; ++t) {
                    ...
                    for (int x = 1; x <= J; ++x) {
                        ...
                        if (as_bool(logical_gt(stan::math::fabs(((get_base1(a, x, "a", 1) + (get_base1(b, x, "b", 1) * get_base1(k_p, t, "k_p", 1))) + get_base1(gf, (((T + t) - x) + J), "gf", 1))), 15))) {
                            ...
                            stan::model::assign(mufor, 
                                        stan::model::cons_list(stan::model::index_uni(pos), stan::model::nil_index_list()), 
                                        gamma_rng(phi, (phi / stan::math::exp(((get_base1(a, x, "a", 1) + (get_base1(b, x, "b", 1) * get_base1(k_p, t, "k_p", 1))) + get_base1(gf, (((T + t) - x) + J), "gf", 1)))), base_rng__), 
                                        "assigning variable mufor");
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                        stan::model::assign(log_lik, 
                                    stan::model::cons_list(stan::model::index_uni(pos2), stan::model::nil_index_list()), 
                                    neg_binomial_2_log_log(get_base1(d, pos2, "d", 1), (((get_base1(offset, pos2, "offset", 1) + get_base1(a, x, "a", 1)) + (get_base1(b, x, "b", 1) * get_base1(k, t, "k", 1))) + get_base1(g, ((t - x) + J), "g", 1)), phi), 
                                    "assigning variable log_lik");
<<<<<<< HEAD
=======
<<<<<<< HEAD:src-x64/stanExports_RHmodel.h
...
>>>>>>> 29d36229bb3e961413905c03b5e6fe3d187d11c1
                        stan::model::assign(log_lik2, 
                                    stan::model::cons_list(stan::model::index_uni(pos3), stan::model::nil_index_list()), 
                                    neg_binomial_2_log_log(get_base1(dval, pos3, "dval", 1), (((get_base1(offset2, pos3, "offset2", 1) + get_base1(a, x, "a", 1)) + (get_base1(b, x, "b", 1) * get_base1(k_p, t, "k_p", 1))) + get_base1(gf, (((T + t) - x) + J), "gf", 1)), phi), 
                                    "assigning variable log_lik2");
<<<<<<< HEAD
...
typedef model_RHmodel_namespace::model_RHmodel stan_model;
<<<<<<< HEAD
=======
<<<<<<< HEAD:src-x64/stanExports_RHmodel.h
=======
