...
#include "stanExports_CBDmodelfinalnb.h"

RCPP_MODULE(stan_fit4CBDmodelfinalnb_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_CBDmodelfinalnb")
