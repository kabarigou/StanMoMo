...
namespace model_APCmodelfinal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_APCmodelfinal");
    reader.add_event(82, 80, "end", "model_APCmodelfinal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_APCmodelfinal : public prob_grad {
private:
        int J;
        int T;
        std::vector<int> d;
        ...
        int L;
public:
    model_APCmodelfinal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_APCmodelfinal_namespace::model_APCmodelfinal";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_APCmodelfinal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            stan::model::assign(g_p, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                        ((((psi + psi2) * get_base1(g, C, "g", 1)) - ((psi * psi2) * get_base1(g, (C - 1), "g", 1))) + (get_base1(sigma, 2, "sigma", 1) * normal_rng(0, 1, base_rng__))), 
                        "assigning variable g_p");
            current_statement_begin__ = 69;
            stan::model::assign(g_p, 
                        stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list()), 
                        ((((psi + psi2) * get_base1(g_p, 1, "g_p", 1)) - ((psi * psi2) * get_base1(g, C, "g", 1))) + (get_base1(sigma, 2, "sigma", 1) * normal_rng(0, 1, base_rng__))), 
                        "assigning variable g_p");
            ...
            for (int t = 3; t <= Tfor; ++t) {
                ...
                stan::model::assign(g_p, 
                            stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                            ((((psi + psi2) * get_base1(g_p, (t - 1), "g_p", 1)) - ((psi * psi2) * get_base1(g_p, (t - 2), "g_p", 1))) + (get_base1(sigma, 2, "sigma", 1) * normal_rng(0, 1, base_rng__))), 
                            "assigning variable g_p");
            }
...
typedef model_APCmodelfinal_namespace::model_APCmodelfinal stan_model;
#endif
