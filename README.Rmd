...
If you have R 4.0.0 or later and use Windows or Mac, you can directly install the binary package via
``` r
install.packages("StanMoMo",repos=c("https://cloud.r-project.org",
"https://kabarigou.github.io/drat"),type = "binary",dependencies = TRUE)
```
Otherwise, you can also install the source package from Github via `devtools`:
``` r
