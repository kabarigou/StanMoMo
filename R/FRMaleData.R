...
#' \describe{
#'   \item{Dxt}{Matrix of deaths, with 111 rows (ages) and 202 colums (years)}
#'   \item{Ext}{Matrix of exposures, with 111 rows (ages) and 202 colums (years)}
#' }
...
#' for Demographic Research (Germany). Available at \url{http://www.mortality.org/}
"FRMaleData"
