...
#' stan_mod create an instance of a Stan model to compute the model evidence through bridge smapling
#'
#' @param mortality_model name of the mortality model, choose from c("lc", "rh", "apc", "cbd", "m6")
#' @param validation number of calendar year in the validation set
#' @param forecast number of year to be predicted
#' @param family death count distribution
...
#'
#' @examples
#' stan_models <- lapply(mortality_models,
