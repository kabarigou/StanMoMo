...
\end{aligned}
$$
To ensure identifiability of the model, we assume that $\sum_x \beta_x=1$ and $\kappa_1=0$. Moreover, we make the standard assumption that the period parameter follows a random walk with drift: 
$$ 
